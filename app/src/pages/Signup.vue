...
<template>
  <div class="flex w-screen h-screen justify-center bg-white">
    <div
      class="flex flex-col w-120 h-150 shadow-2xl border rounded-2xl items-center justify-center gap-2 mt-20"
    >
      <p class="text-4xl text-black font-bold">Sign Up</p>
      <div class="flex flex-row gap-2">
        <p class="flex text-1xl text-black">Already have an account?</p>
      ...
      <Form @submit="handleSignUp" :validation-schema="schema" name="signup">
